     ...
     <div class="" id="userSession">
       <label for="">
         <h3>
           ...
           <?php echo '<a href="infouser.php?u='.base64_encode($_SESSION["user"]["nombre_usuario"]).'" class="label label-primary">'; ?><span id="userName"><?php echo $_SESSION["user"]["nombre_usuario"] ?></span></a>
         </h3>
       </label>
     </div>
