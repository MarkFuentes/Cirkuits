<?php
  ...
  $tipo_renta = (!empty($_POST["tipoSubscripcion"]) ? GetSQLValueString($conexion, $_POST["tipoSubscripcion"], "text") : "");

  $str_update_plastic = sprintf("UPDATE plastic SET nombre_tarjeta = %s, ap_tarjeta = %s, numero_tarjeta = %s, mes_tarjeta = %s,
    anio_tarjeta = %s, cvc_tarjeta = %s, estatus = %s",
  $nombre, $apellido, $numero, $mes, $anio, $cvc, $tipo_renta);
